...
class MPNetPretrainedModel(PretrainedModel):
    ...
    pretrained_resource_files_map = {
        "model_state": {
            ...
            "mpnet-base": "https://huggingface.co/junnyu/mpnet/resolve/main/mpnet-base/model_state.pdparams"
        }
    }
            ...
            if isinstance(layer.weight, paddle.Tensor):
                layer.weight.set_value(
                    paddle.tensor.normal(
                        ...
                        else self.mpnet.config["initializer_range"],
...
class MPNetLMHead(nn.Layer):
    ...
    def forward(self, hidden_states):
        ...
        hidden_states = (
            paddle.matmul(hidden_states, self.decoder_weight, transpose_y=True)
            + self.decoder_bias
        )
...
class MPNetForSequenceClassification(MPNetPretrainedModel):
    def __init__(self, mpnet, num_classes=2, dropout=None):
        ...
        self.dropout = nn.Dropout(
            dropout if dropout is not None else self.mpnet.config["hidden_dropout_prob"]
        )
...
class MPNetForQuestionAnswering(MPNetPretrainedModel):
    def __init__(self, mpnet, num_classes=2):
        ...
        self.mpnet = mpnet
        self.num_classes = num_classes
        self.qa_outputs = nn.Linear(self.mpnet.config["hidden_size"], num_classes)
